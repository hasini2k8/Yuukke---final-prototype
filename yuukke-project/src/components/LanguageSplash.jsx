...
export default function LanguageSplash({ onSelect, translating, translatingName }) {
  return (
    <div style={{
      ...
      {translating ? (
        <div style={{ textAlign: "center" }}>
          <Spinner size={26} color={theme.wine} />
          <p style={{ marginTop: 16, fontSize: 14.5, color: theme.ink, fontFamily: theme.fontBody }}>
            Translating Yuukke into {translatingName}…
          </p>
        </div>
      ) : (
        <>
          ...
          <p style={{ fontSize: 11.5, color: theme.inkSoft, textAlign: "center", maxWidth: 480, marginTop: 30, lineHeight: 1.6 }}>
            Core menus and headings translate instantly with AI. Full translation coverage is still expanding language by language.
          </p>
        </>
      )}
    </div>
