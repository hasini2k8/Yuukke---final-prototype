export const EN_STRINGS = {
  ...
  navLogin: "Log in",
  heroTitle: "Building a future where entrepreneurs rise without limits.",
  heroSubtitle: "A marketplace built by entrepreneurs, for a better world — handcrafted goods, mentorship and enterprise, together.",
