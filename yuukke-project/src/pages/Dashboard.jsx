  ...
  return (
    <DashboardShell goTo={goTo} active="dashboard" businessName={businessName} speechLang={speechLang}>
      <div style={{ background: theme.wine, borderRadius: 20, padding: "32px 34px", color: "#fff", marginBottom: 30, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
        <div>
          <p style={{ fontSize: 12.5, fontWeight: 700, letterSpacing: 1.5, opacity: 0.8, margin: "0 0 8px" }}>APPLICATION SUBMITTED</p>
          <h1 style={{ fontFamily: theme.fontDisplay, fontSize: 28, margin: "0 0 8px" }}>Welcome, {businessName || "seller"}</h1>
          <p style={{ fontSize: 14, opacity: 0.9, margin: 0, maxWidth: 460, fontFamily: theme.fontBody }}>Your onboarding team is reviewing your documents. While you wait, let's build your storefront.</p>
        </div>
      ...
      <h2 style={{ fontFamily: theme.fontDisplay, fontSize: 19, color: theme.ink, margin: "0 0 16px" }}>Build your business</h2>
